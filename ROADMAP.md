...
| 22 | Заменить все plugin embeds в faktura draft на свежие v2 (backward-compat) и перевести `embed10` config на `CarrdPluginOptionsV2`; publish остаётся operator-only | done |
