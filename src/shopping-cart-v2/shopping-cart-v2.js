  ...
  function findOrderField() {
    ...
    return (
      (checkoutForm && (
        ...
        checkoutForm.querySelector('[data-shopping-cart-v2-output="order-details"]') ||
        checkoutForm.querySelector('[data-cart-v2-output="order-details"]') ||
      ...
      document.querySelector('[data-shopping-cart-v2-output="order-details"]') ||
      document.querySelector('[data-cart-v2-output="order-details"]') ||
