(function() {
  ...
  function syncAllCardPaddings() {
    document
      .querySelectorAll(`${CONFIG.cardSelector}[data-cards-initialized="true"]`)
  ...
  function init() {
    ...
    cardContainers.forEach(container => {
      if (container.getAttribute('data-cards-initialized') === 'true') return;
      container.setAttribute('data-cards-initialized', 'true');
