...
Дата: 2026-07-11. Статус: выполнено (Builder). Этот документ сохраняет исторический план миграции; текущий активный контракт описан в `docs/specs/plugin-data-contract.md`, а `slider-v2` уже промотирован в единственный `slider`.
