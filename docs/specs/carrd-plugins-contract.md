# Carrd Plugins V2 Contract

## Назначение
Этот документ задаёт единый контракт для source, docs, build outputs и release workflow репозитория Carrd Plugins V2.
...
- `theme-core-v2.min.css` и `theme-core-v2.min.js` — CDN bundle artifacts.
- `theme-core-v2-cdn.html` — single helper для Head/Body End snippets.
